...
import './App.css';
import { Container, Row, Col, Image, Card, Button, ButtonGroup, Popover, OverlayTrigger } from 'react-bootstrap';
          ...
          <Row className='d-flex align-items-center justify-content-center'>
            ...
            <Col className='px-5' sm={12} md={12} lg={5} xl={5} xxl={5}>
              ...
              <p className="text-center">
                Purple Dungeon is an immaginary game studio made by Simone Bergonzi (aka Murasaki Simema). The studio is a place where Murasaki Simema put his personal project.
              </p>
                  ...
                  <ButtonGroup aria-label="Basic example">
                      ...
                      {!!project.link && project.link !== '' 
                        ...
                        : <OverlayTrigger placement='top' overlay=
                            {
                              <Popover style={{ color: '#ccb4d6', backgroundColor: '#1c1c1d' }}>
                                <Popover.Header style={{backgroundColor: "#745494", color: "#1c1c1d"}}>
                                  <img
                                ...
                                <Popover.Body style={{ color: '#ccb4d6' }}>{project.details}</Popover.Body>
                              </Popover>
                            }
                          >
